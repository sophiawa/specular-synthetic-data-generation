...
class RendererUtility:
    ...
    @staticmethod
    def enable_outlines_output(output_dir, file_prefix="outlines_", output_key="outlines"):
        """ Enables writing outlines images.

        Outlines images will be written in the form of .exr files during the next rendering.

        :param output_dir: The directory to write files to.
        :param file_prefix: The prefix to use for writing the files.
        :param output_key: The key to use for registering the outlines output.
        """
        bpy.context.scene.render.use_compositing = True
        bpy.context.scene.use_nodes = True
        tree = bpy.context.scene.node_tree
        ...
        separate_rgba = tree.nodes.new("CompositorNodeMask")
        space_between_nodes_x = 200
        space_between_nodes_y = -300
        separate_rgba.location.x = space_between_nodes_x
        separate_rgba.location.y = space_between_nodes_y
